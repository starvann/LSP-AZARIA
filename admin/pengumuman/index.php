 ...
 * Menampilkan data ASLI dari tabel `pengumuman` (SELECT + search + filter + pagination).
...
$totalResult = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM pengumuman $whereSql");
$totalRow = mysqli_fetch_assoc($totalResult);
$totalData = (int) $totalRow['total'];
$totalPage = max(1, (int) ceil($totalData / $limit));

$query = "SELECT * FROM pengumuman $whereSql ORDER BY id DESC LIMIT $limit OFFSET $offset";
...
<div class="main-area">
    ...
    <div class="content">
        ...
        <div class="page-head">
            <div>
                <h2>Pengumuman</h2>
                <p>Kelola pengumuman resmi sekolah untuk siswa, orang tua, dan masyarakat.</p>
            </div>
        ...
        <form class="toolbar" method="get" action="index.php">
            <div class="toolbar-filters">
                <div class="search-box">
                    ...
                    <input type="text" name="cari" value="<?php echo htmlspecialchars($cari); ?>" placeholder="Cari judul pengumuman...">
                </div>
                <select class="filter-select" name="kategori" onchange="this.form.submit()">
                    ...
                    <option value="Kesiswaan" <?php echo ($filter_kategori === 'Kesiswaan') ? 'selected' : ''; ?>>Kesiswaan</option>
                </select>
            ...
            <div class="table-scroll">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="cell-muted"><?php echo format_tanggal($row['tanggal_terbit']); ?></td>
                        <td class="cell-muted"><?php echo format_tanggal($row['berlaku_sampai']); ?></td>
