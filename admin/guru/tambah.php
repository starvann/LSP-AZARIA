...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $foto = handle_upload('foto', __DIR__ . '/../uploads/guru/');
    if ($nama === '') {
    ...
    if (empty($errors)) {
        $stmt = mysqli_prepare($koneksi, "INSERT INTO guru (nama, nip, jabatan, mapel, status_kepegawaian, foto) VALUES (?, ?, ?, ?, ?, ?)");
        mysqli_stmt_bind_param($stmt, "ssssss", $nama, $nip, $jabatan, $mapel, $status_kepegawaian, $foto);
...
$activeMenu = 'guru';
$pageTitle = 'Tambah Data Guru & Tendik';
$breadcrumb = ['Data Sekolah', 'Guru &amp; Tendik', 'Tambah'];
